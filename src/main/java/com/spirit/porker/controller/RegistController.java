...
public class RegistController {
	...
	@ResponseBody
	public String regist(@RequestBody UserModel pojo,HttpServletRequest servletRequest, HttpServletResponse servletResponse) {

		BaseResponse<RegistResponse> result = null;

		try {
			result = settingService.regist(pojo,servletRequest,servletResponse);
		} catch (Exception e) {
